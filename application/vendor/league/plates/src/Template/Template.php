...
class Template {
     ...
     * @return string
     */
    public function escape($string, $functions = null, $args = array()) {
        static $flags;
     ...
     * @return string
     */
    public function f($string, $function) {
        $args = array();
        ...
        if ($this->engine->doesFunctionExist($function)) {
            $string = call_user_func_array(array($this, $function), $args);
        } elseif (is_callable($function)) {
    ...
    /**
     * Use function and valid array value.
     * @param  string      $string
     * @param  null|string $functions
     * @return string
     */
    public function af($array, $key, $function) {
        if (isset($array[$key])) {
            $string = $array[$key];
            $args = array();
    ...
    public function a($array, $key, $default = '', $functions = null) {
        if (isset($array[$key])) {
            return $this->escape($array[$key], $functions);
        } else {
            return $default;
        }
    }

    public function aa($array, $key1, $key2, $default = '', $functions = null) {
        if (isset($array[$key1]) && isset($array[$key1][$key2])) {
            return $this->escape($array[$key1][$key2], $functions);
        } else {
            return $default;
        }
    }
