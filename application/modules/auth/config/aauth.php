...
$config_aauth["default"] = array(
    'db_profile' => 'default',
    'no_permission' => 'admin/home/no_perm',
    'login_control' => array(
        'remember' => ' +3 days ',
        ...
        'totp_two_step_login_redirect' => '/auth/user/twofactor_verification/',
        'verification' => false,
        'verification_link' => '/auth/user/verification/',
    ),
    'validation' => array(
        'username' => array(
            'max' => 13,
    ...
    'email' => 'livecn@163.com',
    'name' => 'Yun',
    'email_config' => array(
        'protocol' => 'smtp',
        'smtp_host' => 'ssl://smtp.163.com',
        'smtp_port' => 465,
        'smtp_user' => 'livecn@163.com',
        'smtp_pass' => '',
        'mailtype' => 'html',
        'charset' => 'utf-8'
    ),
    'password' => array(
        ...
        'reset_password_link' => '/auth/user/reset_password/',
    ),
    'pm' => array(
        'pm_encryption' => false,
